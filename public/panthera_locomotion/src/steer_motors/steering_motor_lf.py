...
def adjust_speed(t):
    ...
    d = derivative(current_error, prev_error,t)
    i = integral(accu_error)
    speed = p + i + d
    speed =  -int(speed)
...
if __name__ == "__main__":
    try:
        ...
        service = rospy.Service('lf_steer_status', Status, callback) # Note correct service
